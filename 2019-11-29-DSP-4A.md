...
import("stdfaust.lib");
process = os.osc // Data un'oscillazione bipolare di ampiezza tra +1 e -1 scrivi un programma che la porti ad oscillare tra +1 e 0.
import("stdfaust.lib");
...
import("stdfaust.lib");
process = os.osc (100) +os.osc(100*3) +os.osc(100*6) +os.osc(100*9) +os.osc(100*11) +os.osc(100*13) +os.osc(100*15) +os.osc(100*17) +os.osc(100*19)
